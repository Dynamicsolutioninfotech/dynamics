...
public class UserController {
    ...
    public String userDashboard(@RequestParam Long userId, @RequestParam String username, Model model) {
        ...
        model.addAttribute("username", username);// Replace with actual username
